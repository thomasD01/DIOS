...
.load_kernel_loop:
    ...
    add ax, 31                          ; first cluster = (setup_cluster - 2) * sectors_per_cluster + start_sector
...
.read_finish:
    ...
    jmp SETUP_LOAD_SEGMENT:SETUP_LOAD_OFFSET
...
msg_setup_not_found:    db 'SETUP.BIN file not found!', ENDL, 0
file_setup_bin:         db 'SETUP   BIN'
setup_cluster:          dw 0

SETUP_LOAD_SEGMENT     equ 0x0
SETUP_LOAD_OFFSET      equ 0x500
